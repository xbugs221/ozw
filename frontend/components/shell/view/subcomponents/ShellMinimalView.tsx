        ...
        <div className="absolute inset-x-0 bottom-14 z-20 border-t border-gray-200/80 bg-white/95 p-3 backdrop-blur-sm md:hidden dark:border-gray-700/80 dark:bg-gray-900/95">
          <div className="flex flex-col gap-2">
            <div className="flex items-center justify-between gap-2">
              <p className="text-xs text-gray-600 dark:text-gray-300">Open or copy the login URL:</p>
              <button
                type="button"
            ...
            <input
              ...
              className="w-full rounded border border-gray-300 bg-white px-2 py-1 text-xs text-gray-900 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100"
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="flex-1 rounded bg-gray-200 px-3 py-2 text-xs font-medium text-gray-900 hover:bg-gray-300 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600"
              >
      ...
      {showMobileAuthPanelToggle && (
        <div className="absolute bottom-14 right-3 z-20 md:hidden">
          <button
            ...
            className="rounded bg-white/95 px-3 py-2 text-xs font-medium text-gray-900 shadow-lg ring-1 ring-gray-200 backdrop-blur-sm hover:bg-gray-100 dark:bg-gray-800/95 dark:text-gray-100 dark:ring-0 dark:hover:bg-gray-700"
          >
            Show login URL
          </button>
        </div>
