/**
 * PURPOSE: Contract test for proposal 11. It audits the real chat frontend so
 * composer and session loading rules move out of oversized hooks into focused
 * business modules.
 */
 ...
 *
 * @param source Hook source text.
 * @returns Number of direct API/fetch call markers.
 */
...
test('chat hooks become composition layers', async () => {
