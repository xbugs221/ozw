/**
 * PURPOSE: Contract tests for proposal 5. They audit the backend provider
 * runtime boundary so Codex app-server, Pi SDK, route binding, active-turn,
 * and live transcript responsibilities do not drift back into one large file.
 */
 ...
 * @param symbol Expected exported symbol.
 */
