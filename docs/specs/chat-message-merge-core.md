...
> 合并自归档提案：`2026-06-11-96-建立聊天消息归并内核合同`、`2026-06-11-97-修复Codex-WS气泡顺序和归属`、`2026-06-11-98-稳定Codex流式和ToolCall渲染`、`2026-06-11-102-长会话消息增量瘦身`、`2026-06-14-111-聊天消息归并内核可测化`
