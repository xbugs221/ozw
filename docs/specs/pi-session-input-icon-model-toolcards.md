...
> 合并自归档提案：
> - `2026-06-02-60-优化Pi会话输入区icon和模型选择样式`
> - `2026-06-02-61-优化Pi会话模型选择直接显示下拉框`
> - `2026-06-02-62-修复Pi会话思考块默认展开与工具卡片折叠输出`
> - `2026-06-02-63-修复手动会话工具卡片命令嵌套折叠`
> - `2026-06-03-64-精简流式思考和工具卡片标题并修复顺序`
> - `2026-06-03-65-修复手动会话Edit详情崩溃并移除工具分组名`
> - `2026-06-03-67-修复Codex新会话思考深度选择无效与Pi思考块展示优化`
> - `2026-06-05-73-修复Pi会话消息顺序错乱`
> - `2026-06-05-76-修复Pi工具卡片和不可打开链接渲染`
