...
- **测试文件**：`tests/specs/project-refresh-coordination.spec.ts`
...
- **测试文件**：`tests/specs/project-refresh-coordination.spec.ts`、`tests/spec/project-workspace-navigation.spec.ts`
