...
> 合并自归档提案：`2026-06-01-54-支持Codex手动会话steer`、`2026-06-03-66-修复Codex流式停止和增量渲染`、`2026-06-03-67-修复Codex新会话思考深度选择无效与Pi思考块展示优化`、`2026-06-03-68-修复Codex追加请求气泡排序错乱`、`2026-06-04-70-修复Codex续发WS消息乱序重复`、`2026-06-06-78-修复中文邻接代码块渲染`、`2026-06-06-79-修复Codex实时消息丢正文和错位显示`、`2026-06-06-80-修复文件操作JSON渲染为卡片`、`2026-06-08-87-修复Codex历史会话气泡顺序错乱`、`2026-06-14-113-Codex-app-server-runtime可测化`、`2026-06-14-115-隔离多窗口WebSocket消息归属`
...
> 合并自归档提案：`2026-06-08-88-修复Codex-WS-live文件操作与思考块闪烁`
