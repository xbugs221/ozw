/**
 * PURPOSE: Audits the real docs/specs tree so long mixed-topic specs stay
 * split and current documentation has a searchable index tied to executable
 * tests.
 *
 * Sources: 12-规格文档拆分去冗余与索引更新
 */
