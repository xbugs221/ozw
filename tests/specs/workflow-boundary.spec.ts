/**
 * PURPOSE: Guard workflow read-model and detail-page module boundaries so
 * projection rules, view model state, and UI widgets stay independently
 * reviewable after proposal archival.
 */
...
/**
 * Write runtime evidence required by the archived workflow boundary contract.
 *
 * @param fileName Evidence file name inside the workflow boundary directory.
...
test('WorkflowDetailView.tsx remains a composition layer', async () => {
