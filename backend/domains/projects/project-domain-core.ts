// @ts-nocheck
/**
 * PURPOSE: Private migration core that preserves the existing project,
 * provider-session, manual-route, search, rename, and delete business behavior
 * while public project-domain entry points are exposed by focused ReadModel and
...
import { configureProviderSessionReadModel, deleteProviderSessionIndexFile, indexProviderSessionFile, listIndexedProviderSessionsForProject, upsertProviderSessionIndex, } from './provider-session-read-model.js';
import { buildProviderSessionListReadModel } from './provider-session-list-read-model.js';
import { createDefaultProjectArchiveIndex, getProjectArchiveFilePath, loadProjectArchiveIndex, normalizeProjectArchiveIndex, saveProjectArchiveIndex, } from './project-archive-store.js';
import { bindManualSessionProvider as bindManualSessionProviderInStore, finalizeManualSessionRoute as finalizeManualSessionRouteInStore, initManualSessionRoute as initManualSessionRouteInStore, } from './session-route-store.js';
