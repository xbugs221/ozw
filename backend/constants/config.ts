 ...
 * This is disabled by default and can be enabled with CBW_TRUST_LOCALHOST_AUTH=true.
 */
export const TRUST_LOCALHOST_AUTH = process.env.CBW_TRUST_LOCALHOST_AUTH === 'true';
